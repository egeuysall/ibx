...
- [Published documentation](https://ibx.egeuysal.com/docs)
- [Holocron documentation site source](./ibx-docs)
- [API Reference](./docs/API.md)
- [Authentication Guide](./docs/API_AUTH.md)

Build the documentation site locally with **bun run docs:dev** or **bun run docs:build**. Deploy it with **bun run docs:deploy**.
