    ...
    <main className="min-h-dvh bg-background text-foreground">
      <header className="mx-auto flex w-full max-w-6xl items-center justify-between px-5 py-4 md:px-8">
        <Link href="/" className="flex items-center gap-2" prefetch={false}>
          ...
          />
          <span className="text-sm font-medium tracking-tight">ibx</span>
        </Link>
          ...
          <div className="space-y-4 p-4">
            <div className="rounded-md border bg-background p-3">
              <p className="text-sm text-muted-foreground">
                &gt; schedule launch checklist after lunch and keep the evening clear
              </p>
            </div>
            {[
              ["p1", "Prepare onboarding path for first public users", "2h / today"],
