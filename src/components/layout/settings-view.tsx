...
const SHORTCUT_INSTALL_URL =
  "https://ibx.egeuysal.com/shortcuts/ibx-capture.shortcut?v=20260404-sync-guard";
const SHORTCUT_SYNC_INSTALL_URL =
  "https://ibx.egeuysal.com/shortcuts/ibx-sync-queue.shortcut?v=20260404-sync-guard";
